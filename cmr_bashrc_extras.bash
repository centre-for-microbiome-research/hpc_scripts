...
alias mksquashfs='pixi run --manifest-path /pkg/cmr/sw/pixi_central/pixi.toml mksquashfs'
...
(cd ~/.config/snakemake && ln -sf /work/microbiome/sw/hpc_scripts/snakemake_configs/* . )
